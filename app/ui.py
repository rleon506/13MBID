...
with st.form("prediction_form"):
    ...
    with col1:
        ...
        genero = st.selectbox("⚧️ Género", options=["M", "F"])
    ...
    with col2:
        ...
        personas_a_cargo = st.number_input(    "👨‍👩‍👧 Personas a cargo",    min_value=0,    value=0,    step=1)
    ...
    st.divider()
    st.markdown("## 💼 Información financiera y laboral")
    ...
    with col6:
        ...
        presion_financiera = st.number_input("⚠️ Presión financiera", min_value=0.0, value=2.0, step=0.01, format="%.4f")
    ...
    # GASTOS Y LÍMITES
    # ==============================
    st.caption("Ingrese los datos financieros y operativos del cliente.")
    ...
    with col4:
        gasto_promedio_operacion = st.number_input(
    ...
    with col5:
        operaciones_mensuales_tc = st.number_input(
            "🏦 Operaciones mensuales TC",
            min_value=0.0,
            value=0.0,
            step=1.0,
            format="%.0f"
